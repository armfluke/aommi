...
class PromotionViewAdapter(val mainActivity: MainActivity, val account: Account, val promotionList: ArrayList<Promotion>): RecyclerView.Adapter<PromotionViewAdapter.ViewHolder>() {
